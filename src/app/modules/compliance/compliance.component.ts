...
@Component({
  ...
  template: `
    <div class="reports-container">
              ...
              <p>
                {{
                  selectedReport
                    ...
                    : 'Export standard operational and compliance reports.'
                }}
              </p>
            </div>
          </div>
      ...
      <div
        *ngIf="selectedReport && selectedReport.id === 'active-census'"
        class="detailed-report-card"
      >
            ...
            <tbody>
              <tr *ngFor="let record of filteredPatientRecords" class="patient-row">
                ...
                <td class="patient-id-cell">
                  <button class="patient-link" (click)="navigateToPatient(record)">
                    {{ record.patientId }}
                  </button>
                </td>
                ...
                <td>
                  ...
                  <span *ngIf="!canViewPatientData(record)" class="restricted-text"> *** </span>
                </td>
                <td>
                  <span *ngIf="canViewPatientData(record)">
                    {{ record.gender }}
        ...
        <div class="modal-content break-glass-modal" (click)="$event.stopPropagation()">
          ...
          <div class="modal-body">
            <p class="modal-description">
              You are attempting to access patient data from another facility. This action will be
              audited.
            </p>
            ...
            <div class="attestation-section">
              <label class="attestation-checkbox">
                ...
                />
                <span>
                  I attest that I am accessing this patient record for the purpose of authorized
                  care coordination and have obtained necessary documentation and approvals. This
                  action is audited.
                </span>
              </label>
            </div>
...
export class ComplianceComponent implements OnInit {
  ...
  reports: Report[] = [
    {
      ...
      description:
        'Active patient census including enrollment dates, current phases, and primary counselor assignments.',
      rowLevel: 'Patient',
      rowLevelBg: '#e0e7ff',
    },
    {
    ...
    },
    {
      ...
      description:
        'Detailed log of all Schedule II-V controlled substance dispensations submitted to the state PDMP.',
      rowLevel: 'Dose',
      rowLevelBg: '#e0e7ff',
    },
    {
    ...
    },
    {
      ...
      description:
        'Comprehensive list of all medication dispensing transactions, inventory adjustments, and voids.',
      rowLevel: 'Dose',
      rowLevelBg: '#e0e7ff',
    },
  ];
  ...
  filterPatientRecords(): void {
    ...
    this.filteredPatientRecords = this.patientCensusData.filter(
      (record) =>
  ...
  canViewPatientData(record: PatientCensusRecord): boolean {
    ...
    return (
      record.facilityId === this.currentUserFacilityId ||

...
export class MMUComponent implements OnInit, AfterViewInit {
  ...
  patientsDatabase: Patient[] = [
    ...
    },
    {
      ...
      dose: '12mg',
      rxNumber: 'RX-9988776655',
      lastDoseTime: '02/04 3:15 PM',
      lastDoseHours: 23,
      takeHomeStatus: 'Take-Home Permitted',
      recentDoses: [
        { date: '02/04', time: '3:15 PM', type: 'Observed', amount: '12mg' },
        { date: '02/03', time: '2:45 PM', type: 'Observed', amount: '12mg' },
      ],
      currentEnrollment: {
        facilityId: 'fac-act-001',
        facilityName: 'Anchorage Comprehensive Treatment Center',
    ...
    },
    {
      ...
      currentMedication: 'Methadone',
      dose: '70mg',
      rxNumber: 'RX-5544332211',
      lastDoseTime: '02/05 9:00 AM',
      lastDoseHours: 5,
      takeHomeStatus: 'Take-Home Permitted',
      recentDoses: [
        { date: '02/05', time: '9:00 AM', type: 'Observed', amount: '70mg' },
        { date: '02/04', time: '8:45 AM', type: 'Observed', amount: '70mg' },
        { date: '02/03', time: '9:15 AM', type: 'Observed', amount: '70mg' },
      ],
      currentEnrollment: {
        facilityId: 'fac-cms-anc-001',
        facilityName: 'Community Medical Services – Anchorage',

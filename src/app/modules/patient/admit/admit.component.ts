    ...
    <div class="enrollment-layout">
      ...
      <main class="enrollment-main">
        <div class="enrollment-container">
          ...
          <div class="enrollment-header">
            <div class="header-title-section">
              ...
              <p class="enrollment-subtitle">
                Complete the following steps to enroll a new patient into the OTP registry.
              </p>
            </div>
            ...
            <div class="step-indicator">
              <div
                [class.step-item]="true"
                [class.active]="currentStep === 'demographics'"
                [class.completed]="isStepCompleted('demographics')"
              >
              ...
              <div
                [class.step-item]="true"
                [class.active]="currentStep === 'clinical'"
                [class.completed]="isStepCompleted('clinical')"
              >
              ...
              <div
                [class.step-item]="true"
                [class.active]="currentStep === 'consents'"
                [class.completed]="isStepCompleted('consents')"
              >
              ...
              <form [formGroup]="demographicsForm" (ngSubmit)="nextStep('demographics')">
                ...
                <div class="form-grid-3">
                  <div class="form-group">
                    ...
                    <span
                      *ngIf="
                        demographicsForm.get('firstName')?.invalid &&
                        demographicsForm.get('firstName')?.touched
                      "
                      class="error-text"
                    >
                  ...
                  <div class="form-group">
                    ...
                    <span
                      *ngIf="
                        demographicsForm.get('lastName')?.invalid &&
                        demographicsForm.get('lastName')?.touched
                      "
                      class="error-text"
                    >
                ...
                <div class="form-grid-3">
                  <div class="form-group">
                    ...
                    <span
                      *ngIf="
                        demographicsForm.get('dateOfBirth')?.invalid &&
                        demographicsForm.get('dateOfBirth')?.touched
                      "
                      class="error-text"
                    >
                  ...
                  <div class="form-group">
                    <label class="form-label"
                      >Social Security Number <span class="required">*</span></label
                    >
                    <input
                      type="text"
                      formControlName="ssn"
                    ...
                    <span
                      *ngIf="
                        demographicsForm.get('ssn')?.invalid && demographicsForm.get('ssn')?.touched
                      "
                      class="error-text"
                    >
          ...
          <div
            *ngIf="currentStep === 'duplicate-check'"
            class="enrollment-card duplicate-check-card"
          >
            <div class="card-header amber-header">
              ...
              <div class="header-content">
                ...
                <p class="card-description">
                  We found 1 existing patient record(s) that match the details you entered. Please
                  verify if the patient is already enrolled before creating a new record.
                </p>
              </div>
            </div>
            ...
            <div class="card-content duplicate-content">
              ...
              <div class="match-card">
                ...
                <div class="match-note">
                  <p>
                    This patient is enrolled at another facility. To view details or coordinate
                    care, you must verify identity and attest to having a valid release of
                    information.
                  </p>
                </div>
                ...
                <button
                  type="button"
                  class="btn btn-break-glass"
                  (click)="requestBreakGlassAccess()"
                >
              ...
              <div class="info-box blue-info">
                ...
                <p>
                  If you are certain this is a different person (e.g., same name but different
                  person), you may proceed. Otherwise, cancel this enrollment and manage the
          ...
          <div *ngIf="showBreakGlassDialog" class="modal-overlay">
            <div
              role="alertdialog"
              aria-describedby="break-glass-desc"
            ...
            >
              <div class="modal-header">
                ...
                <p id="break-glass-desc" class="modal-description">
                  You are requesting to "Break Glass" to view a restricted patient record. This
                  action will be logged in the system audit trail and reviewed by the compliance
                  officer.
                </p>
            ...
            <div class="card-content">
              <form [formGroup]="clinicalForm" (ngSubmit)="nextStep('clinical')">
                ...
                <div class="form-grid-2">
                  <div class="form-group">
                    ...
                    <div class="input-icon-left">
                      ...
                      <input type="date" formControlName="enrollmentDate" class="form-input" />
                    </div>
                    <span
                      *ngIf="
                        clinicalForm.get('enrollmentDate')?.invalid &&
                        clinicalForm.get('enrollmentDate')?.touched
                      "
                      class="error-text"
                    >
                  ...
                  <div class="form-group">
                    ...
                    <span
                      *ngIf="
                        clinicalForm.get('medication')?.invalid &&
                        clinicalForm.get('medication')?.touched
                      "
                      class="error-text"
                    >
                ...
                <div class="form-grid-2">
                  <div class="form-group">
                    <label class="form-label"
                      >Initial Dose (mg) <span class="required">*</span></label
                    >
                    <input
                      type="number"
                    ...
                    <span
                      *ngIf="
                        clinicalForm.get('initialDose')?.invalid &&
                        clinicalForm.get('initialDose')?.touched
                      "
                      class="error-text"
                    >
                  ...
                  <div class="form-group">
                    ...
                    <span
                      *ngIf="
                        clinicalForm.get('frequency')?.invalid &&
                        clinicalForm.get('frequency')?.touched
                      "
                      class="error-text"
                    >
                  ...
                  <div class="checkbox-card">
                    <div class="checkbox-wrapper">
                      ...
                      <div class="checkbox-content">
                        <label for="takeHome" class="checkbox-title"
                          >Patient Authorized for Take-Home Doses</label
                        >
                        <p class="checkbox-description">
                          Overall authorization status. Individual doses may vary based on clinical
                          assessment.
                        </p>
                      </div>
                    </div>
          ...
          <div *ngIf="currentStep === 'consents'" class="enrollment-card">
            <div class="card-header">
              ...
              <div class="header-content">
                ...
                <p class="card-description">
                  Required legal consents for data sharing and treatment.
                </p>
              </div>
            </div>
              ...
              <form [formGroup]="consentsForm" (ngSubmit)="submitEnrollment()">
                <div class="consents-section">
                  ...
                  <div class="consent-checkbox-card sota-required">
                    ...
                    <p class="consent-description">
                      I attest that the patient has consented to share their admission and treatment
                      data with the <strong>State Opioid Treatment Authority (SOTA)</strong> and a
                      signed release is on file.
                    </p>
                  </div>
                  ...
                  <div class="consent-checkbox-card pdmp-optional">
                    ...
                    <p class="consent-description">
                      I attest that the patient has consented to share their dispensing data with
                      the state <strong>Prescription Drug Monitoring Program (PDMP)</strong> and a
                      signed release is on file.
                    </p>
                    <p class="consent-helper">
                      Leave unchecked if patient has declined PDMP consent.
                    </p>
                  </div>
                </div>
                ...
                <div class="attestation-box">
                  ...
                  <p class="attestation-text">
                    <strong>By submitting this enrollment,</strong> you attest that you have
                    verified the patient's identity, reviewed all enrollment criteria, and confirmed
                    that all required consents are signed and filed in accordance with state and
                    federal regulations.
                  </p>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <button
                    type="submit"
                    class="btn btn-primary"
                    [disabled]="!consentsForm.valid || isSubmitting"
                  >
...
export class AdmitComponent implements OnInit {
  ...
  confirmBreakGlassAccess(): void {
    ...
    this.successMessage =
      'Break Glass access has been granted. You can now proceed with enrollment.';
  }

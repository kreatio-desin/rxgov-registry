...
export const routes: Routes = [
  ...
  {
    path: 'facilities',
    loadComponent: () => import('./modules/facilities/facilities.component').then(m => m.FacilitiesComponent)
  },
  {
    path: 'emergency',
  ...
  {
    path: 'compliance',
    loadComponent: () => import('./modules/compliance/compliance.component').then(m => m.ComplianceComponent)
  },
  {
    path: 'settings',
  ...
  },
  {
    ...
    children: [
      {
        path: 'facilities',
        loadComponent: () => import('./modules/admin/admin-facilities.component').then(m => m.AdminFacilitiesComponent)
      }
    ]
  }
];
